...
def sanitize_column_names(df):
    # Updated to handle columns starting with numbers and containing special characters
    df.columns = [f'"{col}"' if re.match(r'^\d', col) or re.search(r'\W', col) else col for col in df.columns]
    return df
